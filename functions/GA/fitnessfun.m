...
fsum = sum(Fitvalue);
Pperpopulation = Fitvalue/fsum;                                            % Check fitness value sensitivity
Pperpopulation = (1-Pperpopulation).^(Index*popsize); 
Pfsum = sum(Pperpopulation);
Pperpopulation = Pperpopulation/Pfsum;                                     % Check fitness value sensitivity
